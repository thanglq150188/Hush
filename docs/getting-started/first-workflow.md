...
Tạo file `resources.yaml` trong thư mục project:
...
# Đường dẫn đến resources.yaml (optional nếu file ở thư mục hiện tại)
...
| `HUSH_CONFIG` | Biến môi trường chỉ định config path |

## Tiếp theo

- [Khái niệm cốt lõi](../concepts/overview.md) - Hiểu sâu về kiến trúc
- [State Management](../concepts/state-management.md) - Chi tiết về data flow
- [ResourceHub](../concepts/resource-hub.md) - Quản lý resources
- [Xây dựng Workflows](../guides/building-workflows.md) - Patterns nâng cao
